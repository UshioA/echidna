...
import Data.Aeson
import Data.Aeson qualified as StateMachine
...
import Echidna.StateMachine (readJsonFile)
import Echidna.Test
import Echidna.Types.Campaign
import Echidna.Types.Config
import Echidna.Types.Coverage (CoverageFileType (..))
import Echidna.Types.Solidity
import Echidna.Types.StateMachine (StateMachine)
import Echidna.Types.Test (TestConf (..))
import Echidna.Types.Tx (TxConf (TxConf), defaultBlockDelay, defaultTimeDelay, maxGasPerBlock)
    ...
    where
      ...
      parser v =
        ...
        where
          ...
          txConfParser =
            -- transaction config, why name it parser though
            TxConf
          ...
          -- TODO: add proper decode fro stateMachine
          campaignConfParser =
            CampaignConf
              ...
              <*> v ..:? "stateMachineJson" ..!= defaultStateMachineJson
              -- <*> v ..:? "stateMachine" ..!= defaultStateMachine
